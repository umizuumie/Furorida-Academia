...
label day_1_school_lunch:
    ...
    teacher_white "Ahem!"
    player "Oh, sorry."
    teacher_white "Welcome to the Furorida Cafe. What will you be having today?"
    player "Uh..."
    player "Let me get, uh..."
    teacher_white "Come on, order something."
    player "A salad!"
    player "Yeah, a salad..."
    teacher_white "Alrighty, one salad coming up."
    teacher_white "What dressing would you like with that?"
    ...
    menu:
        ...
        "Ranch Dressing":
            ...
            teacher_white "Ranch, good choice."

        "Italian Dressing":
            $ var_string_saladdressing = "italian"
            player "Italian please."
            teacher_white "Italian it is."

    teacher_white "Would you like to add on a drink with that?"
    player "No thank you."
    teacher_white "Okay, just one salad."

    $ var_integer_randomroll = renpy.random.randint(1, 100)

    if var_integer_randomroll <= 99:
        teacher_white "Your total will be $9.56."
    else:
        teacher_white "Your total will be $9.67."

    teacher_white "Will you be paying with cash or card today?"
    player "Total...? Paying...?"
    player "I uh, don't have my wallet."
    teacher_white "That's okay, do you have tap-to-pay on your phone?"
    player "Tap-to-pay?"
    player "I think I do."
    teacher_white "Great, just tap your phone when you're ready."
    event "..."
    teacher_white "I'm sorry, your card declined."
    teacher_white "You are welcome to tap again."
    narrator "Declined? I guess I'm short on money..."
    player "It's fine. You can cancel the order."
    teacher_white "Well in that case, you can check out the room next door."
    teacher_white "Our food pantry offers free food to students who need it."
    narrator "Free?"
...
label day_1_school_class_physical_education:
    ...
    teacher_cooper "Everybody get in line! Single file!"
    teacher_cooper "It's time for roll call!"
    luthor "What, is this a prison or something?"
    teacher_cooper "Funny one here, you're going first."
    teacher_cooper "Raise your hand high, and say present!"
    luthor "Oh well, present."
    teacher_cooper "...We'll work on it. Let's see who else is here."
    teacher_cooper "Late scrawny kid!"
    player "Really...? I mean- Present!"
    teacher_cooper "And Randy?"
    randy "Here coach!"
    teacher_cooper "You're supposed to say present."
    randy "Oh uh... present!"
    teacher_cooper "Chris!"
    ...
    luthor "Yeah, okay..."
    teacher_cooper "Quiet down, Quiet down! We're not finished."
    teacher_cooper "Last one, don't mess this up!"
    teacher_cooper "Sienna!"
    event "..."
    teacher_cooper "Sienna Rivera!"
    sienna "Yeah whatever. Uh, present."
    teacher_cooper "Okay... I don't want to make this tough for you all, especially on the first day."
    teacher_cooper "But this, is not acceptable!"
    teacher_cooper "Everybody needs to fall in line!"
    teacher_cooper "We're gonna be running around this gym, no slacking!"
    teacher_cooper "Let me get my stopwatch..."
    ...
    teacher_cooper "No, no, Chris, why would you tell them that?"
    teacher_cooper "Just because of that, Randy has to run first."
    randy "B-but..."
    teacher_cooper "GO!"
    randy "Yes sir!"
    luthor "..."
    ...
    teacher_cooper "Alright, since you two can't shut your mouths! You two are going next!"
    teacher_cooper "Luthor, next! Then Chris."
    luthor "..."
    luthor "Dammit..."
    event "..."
    ...
    teacher_cooper "Chris, you're up!"
    chris "But it's that other guy's turn..."
    teacher_cooper "Chris! Go... NOW!!!"
    chris "Ughhhh! Fine!"
    ...
    menu:
        ...
        "Help Sienna":
            ...
            teacher_cooper "Sienna, your turn!"
            sienna "Damn it."
    ...
    teacher_cooper "What! Huh!"
    teacher_cooper "Looks like class is over."
    teacher_cooper "Everyone who ran, give me your times."
    teacher_cooper "The rest of you will finish up tomorrow."
...
label day_1_school_class_science:
    ...
    teacher_huffel "Come in everybody, come in!"
    teacher_huffel "Have a seat everyone, any seat at all."
    teacher_huffel "Hope you all are ready for some science, because we're gonna get right into that."
    teacher_huffel "But first of all, attendance."
    teacher_huffel "Jake! Jake Glue!"
    jake "I'm present! Or... I was present, but that was in the past."
    teacher_huffel "Good one Jake! You're the glue that holds my classroom together."
    teacher_huffel "Now we have Locke?"
    locke "Present! Wait, presents? Is it Christmas already?"
    narrator "Oh great, the hall monitor is in here."
    teacher_huffel "Sure is, Locke! Now is Jesse here?"
    jesse "R-Right here, Mr. Huffel!"
    teacher_huffel "And last but not least, Faith! Faith Walker."
    faith "Over here!"
    teacher_huffel "Great, everyone's here!"
    player "Uhh... Mr. Huffel? What about me?"
    teacher_huffel "Don't worry I already have you written down."
    teacher_huffel "Now, before we get into all the fun and interesting science..."
    teacher_huffel "We first need to talk about the importance of lab safety!"
    teacher_huffel "We have goggles and gloves in the cabinets to the right of the class, next to the windows."
    teacher_huffel "And while you all should be careful enough to never have to use it, we have an eye wash station in the corner."
    teacher_huffel "As well as a shower area next to it. With some curtains for privacy."
    ...
    teacher_huffel "Yes, but there are curtains! And it's only if you get some really dangerous stuff on you!"
    teacher_huffel "Now does everyone understand our lab safety?"
    faith "Sure... I think."
    jake "You know it, Mr. Huffel!"
    teacher_huffel "Now, let's begin."
    teacher_huffel "I need three groups of two, so everyone form a group!"
    jake "But Mr. Huffel, you have five students!"
    teacher_huffel "Darn, you're right. Come work with me, Jake!"
    ...
    menu:
        ...
        "Faith":
            ...
            player "Anyways, uh... Mr. Huffel!"
            teacher_huffel "Yes?"
            player "Me and Faith are grouping up."
            teacher_huffel "Perfect! I assume that means Locke and Jesse are grouping up as well?"
        ...
        "Locke":
            ...
            locke "Mr. Huffel! I found my partner!"
            teacher_huffel "Fantastic Locke!"
        ...
        "Jesse":
            ...
            teacher_huffel "Jesse, are you two a group?"
            jesse "Yeah..."
            teacher_huffel "Alright, that means Faith and Locke are grouping up I assume?"
            faith "Guess so...!"

    teacher_huffel "Then everyone's decided! Let's get to the lesson now."
    teacher_huffel "So, each group is going to get a bottle of soda, and we're gonna put some mentos into it!"
    teacher_huffel "So, come up here and grab your bottle."
    jake "And then whats after the mentos? Do we calculate anything?"
    teacher_huffel "Of course not! Now come on ahead!"
    ...
    if var_string_sciencepartner == "faith":
        ...
        narrator "..."
        player "I'm here."
        teacher_huffel "Here you go! Be careful with it!"
        teacher_huffel "Don't want to see it explode early! Right?"
