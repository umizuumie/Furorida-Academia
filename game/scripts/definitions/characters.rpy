...
define teacher_white = Character(_("Ms. White"), color="#9c5679")
define teacher_abulmi = Character(_("Mr. Abulmi"), color="#6f6600")
define teacher_oneal = Character(_("Mr. O'Neal"), color="#507000")
define teacher_ingram = Character(_("Ms. Ingram"), color="#575757")
define teacher_reyes = Character(_("Dr. Reyes"), color="#70004b")
define teacher_cooper = Character(_("Mr. Cooper"), color="#706800")
define teacher_leighliter = Character(_("Mrs. Leighliter"), color="#705200")
define teacher_huffel = Character(_("Mr. Huffel"), color="#2a077c")