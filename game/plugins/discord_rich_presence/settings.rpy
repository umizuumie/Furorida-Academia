...
define discord.application_id = "1481040763344388297"

#####################################################################################################################################

# State of the Presence upon the game's launch and return to the main menu..
define discord.main_menu_state = {
    "details": "Browsing the Main Menu",
    "large_image": "game-icon",
    "large_text": "Furorida Academia",
    "small_image": "icon-badge",
    "small_text": "(v" + config.version + ")"
}
